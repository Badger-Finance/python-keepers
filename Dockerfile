...
RUN apt-get install libssl-dev>=1.1.1n-0+deb11u3 libssl3 openssl>=1.1.1k-1+deb11u2 -y
...
RUN apt-get install libtiff6>=4.2.0-1+deb11u3 -y
...
# RUN apt-get install libpcre2-posix2>=10.39 -y
